 ...
 * ノードの深さを計算する
 */
function getNodeDepth(node: AriaNode, currentDepth: number = 0): number {
 ...
 * ノード内のリンク数をカウントする
 */
function countLinks(node: AriaNode): number {
